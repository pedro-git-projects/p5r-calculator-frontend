      ...
      <table className="aspect-ratio aspect-ratio-auto w-screen table-auto">
        <thead>
          <tr>
            ...
            <th className="px-2 py-1 text-sm bg-gray-200 border">Resistances</th>
        ...
        <tbody>
          <tr>
            ...
            <td className="px-2 py-1 border text-sm">{formatResistances(persona.resists)}</td>
            <td className="px-2 py-1 border text-sm">{formatSkills(persona.skills)}</td>
            <td className="px-2 py-1 border text-sm">{formatStats(persona.stats)}</td>
